...
kanton <- st_read("L:/STAT/08_DS/03_GIS/Geodaten/2020/BezirkeAlleSee_F_KTZH_2020.shp", stringsAsFactors = FALSE, crs=2056)
...
path_2056 = "C:/gitrepos/Ressources_Maps/2020/BezirkeAlleSee_gen_epsg2056_F_KTZH_2020.json"
file.remove(path_2056)
## [1] TRUE
st_write(kanton_gen, path_2056, driver="GeoJSON")
